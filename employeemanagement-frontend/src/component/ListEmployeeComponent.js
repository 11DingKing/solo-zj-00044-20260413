                ...
                <tbody>
                    {employeeArray.map(employee =>
                        <tr id={employee.id}>
                            ...
                            <td>
                                <Link to={`/employee-detail/${employee.id}`} className='btn btn-primary btn-sm' href="">View</Link> {" "}
                                <Link to={`/add-employee/${employee.id}`} className='btn btn-info btn-sm' href="">Update</Link> {" "}
